...
> = {
  ...
  spot_removal: {
    ...
    templates: ['otag:spot-removal', 'otag:removal -otag:boardwipe'],
    negativeTemplates: [],
  ...
  modern_legal: {
    aliases: ['modern legal', 'legal in modern', 'modern format'],
    templates: ['f:modern'],
    negativeTemplates: [],
    description: 'Cards legal in Modern format',
    category: 'format',
    priority: 60,
  },
  standard_legal: {
    aliases: ['standard legal', 'legal in standard', 'standard format'],
    templates: ['f:standard'],
    negativeTemplates: [],
  ...
  pioneer_legal: {
    aliases: ['pioneer legal', 'legal in pioneer', 'pioneer format'],
    templates: ['f:pioneer'],
    negativeTemplates: [],
    description: 'Cards legal in Pioneer format',
    category: 'format',
    priority: 60,
  },
  pauper_legal: {
    aliases: ['pauper legal', 'legal in pauper', 'pauper format'],
    templates: ['f:pauper'],
    negativeTemplates: [],
    description: 'Cards legal in Pauper format',
    category: 'format',
    priority: 60,
  },
  ...
  equipment: {
    aliases: ['equipment', 'equipments', 'equip'],
    templates: ['t:equipment'],
    negativeTemplates: [],
  ...
  aura: {
    aliases: ['aura', 'auras', 'enchant creature'],
    templates: ['t:aura'],
    negativeTemplates: [],
  ...
  planeswalker: {
    aliases: ['planeswalker', 'planeswalkers', 'walkers'],
    templates: ['t:planeswalker'],
    negativeTemplates: [],
  ...
  // === PROTECTION ===
  protection: {
    aliases: ['protection', 'has protection', 'protection from'],
    templates: ['o:"protection from"'],
    negativeTemplates: [],
    description: 'Cards with protection abilities',
    category: 'keyword',
    priority: 70,
  },
  shroud: {
    aliases: ['shroud', 'has shroud'],
    templates: ['o:shroud'],
    negativeTemplates: [],
    description: 'Cards with shroud',
    category: 'keyword',
    priority: 70,
  },
};
