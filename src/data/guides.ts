...
export const GUIDES: Guide[] = [
  ...
  // ───────── LEVEL 2: Color Filtering ─────────
  {
    ...
    metaTitle: 'MTG Color Search — Find Cards by Color or Identity | OffMeta',
    metaDescription:
  ...
  // ───────── LEVEL 3: Price & Budget Filtering ─────────
  {
    ...
    metaTitle: 'Budget MTG Card Finder — Cheap Staples Under $5 | OffMeta',
    metaDescription:
  ...
  // ───────── LEVEL 9: ETB & Flicker Combos ─────────
  {
    ...
    metaTitle: 'MTG ETB & Flicker Combos — Best Blink Cards (2026) | OffMeta',
    metaDescription:
