...
/** Every functional (oracle) tag Scryfall indexes for otag:/oracletag:/function: searches. */
export const SCRYFALL_ORACLE_TAGS: readonly string[] = [
  ...
  "continuous-effect-in-graveyard",
  "control-attacker",
  "control-blocker",
