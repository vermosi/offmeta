      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative py-20 sm:py-32 px-4 overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed mb-12 max-w-2xl mx-auto">
              OffMeta started as a simple question:{' '}
              <em>
                &quot;What if you could find Magic cards just by describing what
                you want?&quot;
              </em>{' '}
              Six phases shipped. Collections, market data, deck sharing, and 11
              languages later — it&apos;s becoming a full intelligence platform.
            </p>
        ...
        <section className="border-t border-border/30 py-16 sm:py-20 px-4">
          <div className="max-w-2xl mx-auto text-center">
            <div className="brand-discord-surface inline-flex h-14 w-14 items-center justify-center rounded-2xl mb-5">
            ...
            <p className="text-muted-foreground text-sm mb-8 max-w-lg mx-auto leading-relaxed">
              Share deck ideas, suggest features, report bugs, and chat with
              other players building with OffMeta.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a
                ...
                className="brand-discord-button inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-colors"
              >
                <svg
                  className="h-4 w-4"
                  aria-hidden="true"
        ...
        <section className="border-t border-border/30 bg-card/20 py-16 sm:py-20 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-sm mb-10 max-w-lg mx-auto">
              Every phase brought OffMeta closer to the tool serious Magic
              players deserve. Try it now — all of it is free.
            </p>
