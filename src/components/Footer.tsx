...
export function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-border/60 bg-card/30" role="contentinfo">
      <div className="container-main space-y-5 py-6 sm:py-8">
        <div className="flex items-center justify-center gap-2 sm:justify-start">
          <div
            className="flex h-5 w-5 items-center justify-center rounded-full border border-border/70 bg-background text-[10px] font-semibold text-foreground shadow-sm sm:h-6 sm:w-6"
            aria-hidden="true"
          >
            O
          </div>
