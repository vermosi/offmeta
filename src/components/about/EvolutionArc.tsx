...
const MILESTONES = [
  ...
  { year: 'Early 2026', label: 'Search + Deckbuilder + Combos' },
  { year: 'Mid 2026', label: 'Platform: Collections, Market, Social' },
  { year: 'Late 2026', label: 'Meta Intelligence & AI Insights' },
];
    ...
    <section className="py-16 sm:py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-muted-foreground text-sm mb-12 max-w-xl mx-auto">
          From a query translator to a full meta-intelligence platform — this is where OffMeta is
          going.
        </p>
                  ...
                  style={{
                    borderColor:
                      i < 3
                        ...
                        : 'hsl(var(--muted-foreground))',
                    background:
                      i < 3 ? 'hsl(var(--accent) / 0.15)' : 'hsl(var(--muted) / 0.5)',
                  }}
                />
                <div>
                  <p className="text-sm font-semibold text-foreground">{m.year}</p>
